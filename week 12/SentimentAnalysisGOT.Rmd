...
Min forventning til min sentiment analysis af Game of Thrones var, at der i høj grad ville være en overvægt af negative ord/stemninger.

Visualiseringerne viser en graf over de mest repræsentative ord i GOT-bøgerne samt den følelse, som NRC-lexiconet har knyttet til ordet. En sådan visualisering giver indblik i den/de dominerende stemning(er) i bøgerne og kan dermed skabe et billede af bøgernes stemningskarakter. Ser vi på den første graf (visualisering 1), er der en svag overvægt af henholdsvis positive ord over negative ord. Ser man på de specifikke følelser/stemninger, i den anden graf (visualisering 2), er det især ord knyttet til "trust" og "fear", der er mest repræsenteret.
Det betyder dog ikke, at man herudfra kan drage en konklusion om bogens stemninger. Ser vi på det mest repræsenterede ord i "trust", er det "lord" – i NRC kan dette ord både knytte sig til positive, negative, trust og disgust. Altså er man nødt til at kende konteksten for at kunne afkode ordets stemning. Desuden bruges ordet i Game of Thrones meget ofte i tiltale af en adelsmand, og man kan spørge, hvorfor det enten skulle være trust/disgust eller positiv/negativ. Dette viser fint, at en sentiment analysis har pitfalls og ikke nødvendigvis er præcis eller sigende, når den står alene.
I den forbindelse kan man sige, at det, som grafen IKKE viser, netop er konteksten. Et andet eksempel kunne være "mother", der har følelsen "sadness" knyttet til sig. Igen er det uigennemskueligt hvorfor uden en kontekst. Omvendt kan man argumentere for, at netop "trust" og "fear" er to kernestemninger i bøgerne. Trust skabes ofte af alliancer mellem mennesker og loyalitet – begge dele er store emner i bøgerne. Samtidig er "fear" hele tiden nærværende; brydes alliancerne? Kan man stole på, at andre er loyale over for en?
